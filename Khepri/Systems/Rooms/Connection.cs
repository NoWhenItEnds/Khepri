...
namespace Khepri.Rooms
{
    ...
    public class Connection : IEquatable<Connection>
    {
        ...
        public Connection(Room roomA, Room roomB)
        {
            ...
            {
                throw new ArgumentException($"Unable to create a connection between the same two rooms.");  // TODO - Add the room's name / uid.
            }
        ...
        /// <returns> The rooms connected by this connection. </returns>
        public Room[] GetRooms() => _rooms.ToArray();


        /// <inheritdoc/>
        public override Int32 GetHashCode() => _rooms.GetHashCode();


        /// <inheritdoc/>
        public override Boolean Equals(Object? obj) => obj is Connection other && (_rooms[0].Equals(other.GetRooms()[0]) || _rooms[0].Equals(other.GetRooms()[1]));  // TODO - Will this work?


        /// <inheritdoc/>
        public Boolean Equals(Connection? other) => other is not null && (_rooms[0].Equals(other.GetRooms()[0]) || _rooms[0].Equals(other.GetRooms()[1]));  // TODO - Will this work?
    }
}
