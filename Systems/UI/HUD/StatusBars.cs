...
namespace Khepri.UI.HUD
{
    ...
    public partial class StatusBars : Control
    {
        ...
        {
            _staminaBar.Value = _playerController.PlayerUnit.Data.CurrentStamina;
            _healthBar.Value = _playerController.PlayerUnit.Data.CurrentHealth;
            _hungerBar.Value = _playerController.PlayerUnit.Data.CurrentHunger;
            _fatigueBar.Value = _playerController.PlayerUnit.Data.CurrentFatigue;
            _entertainmentBar.Value = _playerController.PlayerUnit.Data.CurrentEntertainment;
