...
{
    /// <summary> Singleton base class backed by <see cref="Node2D"/>. Use this when the singleton participates in 2D scene rendering or physics. </summary>
    /// <typeparam name="T"> The concrete singleton type — must derive from this class (CRTP). </typeparam>
    public abstract partial class SingletonNode2D<T> : Node2D where T : SingletonNode2D<T>
    {
